...
def sol_b(stacks_filepath, instructions_filepath):
    ...
    for instruction in instructions_all:
        ...
        cache.reverse()
        stacks_all[target] = target_stack + cache
...
"""test_b = sol_b("test stacks.txt","test instructions.txt")
actual_b = sol_b("input stacks.txt","input instructions.txt")"""